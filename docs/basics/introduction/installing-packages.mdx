...
<Admonition type="tip" title="CopyPaste">
  If you just copy/paste the `greet2` folder and rename it to `greet3`, remember
  to update `go.mod`, and all the files that use the module!
</Admonition>
...
<Admonition type="tip" title="Package Directory">
  ...
  get the package **repository name** 👍
</Admonition>
