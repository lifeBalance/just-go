...
If you're new to Go, you may find this pattern a bit hard to read at first. But once you start working with Go codebases, you'll see its use is generalized, and will get used to it.
</Admonition>