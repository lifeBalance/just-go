...
Expressions using [operators](https://go.dev/ref/spec#Operators):
...
Go’s [operators](https://go.dev/ref/spec#Operators) follow standard mathematical precedence. From highest to lowest:
