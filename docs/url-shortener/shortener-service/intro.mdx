...
In the previous **Setup** section, we implemented the shortener service, and wire it up in the **entry point** of the app, using **DI**. But if you check the code, we're just returning a hardcoded shortcode:
