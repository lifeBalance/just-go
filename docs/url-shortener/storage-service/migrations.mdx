...
Next we’ll wire migrations so our DB schema (tables for short codes, metadata,
...
If you use this method, be aware of possible variables you may have set in other projects 😬
</Admonition>
...
Another option is to create a `Makefile` like this one:
...
# Enter migration name: create_urls_table
...
<Admonition type="tip" title="Blank Slate">
If during **development** you find yourself in a weird state, just nuke the db volume: `docker-compose down -v`, and run migrations again.
</Admonition>