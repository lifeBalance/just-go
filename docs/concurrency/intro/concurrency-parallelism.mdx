...
You're using common sense to split and organize your work — tackling the next task while something else is waiting, instead of standing still. If you were a program, this is exactly what **concurrent programming** is about: structuring tasks to overlap and make progress without blocking.
